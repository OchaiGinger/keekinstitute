          ...
          >
            ...
            >
              <button
                ...
                className="group text-lg h-14 px-8 shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all bg-primary text-primary-foreground rounded-lg font-semibold hover:bg-primary/90 flex items-center gap-2 w-full sm:w-auto justify-center"
              >
                Get Started
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
              <button
                className="text-lg h-14 px-8 border-2 border-primary/50 hover:bg-primary/10 hover:border-primary transition-all rounded-lg font-semibold flex items-center gap-2 w-full sm:w-auto justify-center"
              >
